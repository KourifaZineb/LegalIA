...
public class UserActivityServiceImpl implements UserActivityService {
    ...
    @Override
    public UserActivity logActivity(LogActivityRequest request, Long userId) {
        User user = userRepository.findById(userId)
        ...
        activity.setUser(user); // ✅ Ajout du lien avec l'utilisateur

        userActivityRepository.save(activity);
        return userActivityRepository.findById(activity.getActivityId())
